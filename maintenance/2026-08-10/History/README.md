...
| `2026-08-10` | `00-current-state.md`（コンテキスト消費の計測）、`01-improvement-plan.md`（段 0〜8 の改善計画）、`02-development-modes.md`（開発方式の検討経緯）、`03-decision-record.md`（Chapter 8 削除・重複 7 箇所・用語・採番の検討経緯） |
