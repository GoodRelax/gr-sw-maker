...
現在も使うファイルはここに無い。1 つ上の `maintenance/2026-08-10/` に 8 つある。索引は同フォルダの `README.md`。
...
| エージェント連携の根拠 | `06-agent-connection-report.md` |
| エージェント連携の規則 | `07-agent-orchestration-rules.md` |
