...
現在も使うファイルはここに無い。1 つ上の `maintenance/2026-08-10/` に 5 つある。索引は同フォルダの `README.md`。
...
| `2026-08-10` | `00-current-state.md`（コンテキスト消費の計測）、`01-improvement-plan.md`（段 0〜8 の改善計画）、`02-development-modes.md`（開発方式の検討経緯）、`03-decision-record.md`（Chapter 8 削除・重複 7 箇所・用語・採番の検討経緯）、`04-glossary-state.md`（用語集 手順 1a の適用記録） |
