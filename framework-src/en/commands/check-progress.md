...
4. Report the current defect curve values
5. Report the current coverage values
6. Report the current cost consumption values
7. Identify any bottlenecks if present
8. Propose the next actions to be taken
